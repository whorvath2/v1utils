...
<h2>Usage Notes</h2>
<p>This package stores the access token for the VersionOne API in encrypted form in a plain-text file called <span style="font-family: courier;">enc_token</span>. To create a new encrypted access token, use the Token Utilities from the command line to convert the token from plain text: <div>java -jar [jarFileName] com.billhorvath.v1mods.TokenUtils [unencryptedToken]</div></p>
